...
export default function ContactForm() {
  const [ratePlan, setRatePlan] = useState("Սկսնակ");
  ...
  // Передаем объект события (e) в функцию
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Form Submitted:", { ...formData, ratePlan });
    // Add form submission logic here (e.g., send to an API)
  };

  return (
    <section
      className="py-12 bg-gray-50 flex flex-col lg:flex-row justify-around px-0 lg:px-20 gap-5 mb-10"
      id="contact"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-4 ">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 custom_showld">
            Լրացրեք ձևը դիմումի համար:
          </p>
        </div>

        <form
          onSubmit={handleSubmit}
          className="max-w-3xl mx-auto bg-white p-8 shadow-custom-notary rounded-lg shadow-md"
        >
          <div className="mb-4">
            <label
              htmlFor="name"
          ...
          <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="Կորպորատիվ">Կորպորատիվ</option>
              </select>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="block w-full border border-gray-300 rounded-md shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500"
              rows={1}
              placeholder="Գրեք Ձեր մեկնաբանություն այստեղ"
              disabled
            ></textarea>
          </div>
      ...
      <div className="flex justify-center items-center w-full  min-h-[650px] custom_bg px-4 sm:px-6 lg:px-4">
        <div className="p-10 md:p-16 lg:p-20  bg-white flex flex-col gap-8 items-center text-center shadow-custom-notary rounded-lg">
          {/* Логотип и название */}
